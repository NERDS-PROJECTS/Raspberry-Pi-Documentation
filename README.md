...
1) **Raspberry Pi**<br> 
	...
	iii) Raspberry Pi Model B+<br>                             
  	iv) Raspberry Pi 2<br>
	v) Raspberry Pi 3 Model B<br>
...
*Storage*<br>
To store all of its files including the Raspberry Pi OS operating system, our Raspberry Pi needs an SD card. We need a microSD card with a capacity of at least 8GB. For the Raspberry Pi, many vendors offer SD cards that are pre-installed with the operating system and ready to use.<br>
![pi-sd](https://user-images.githubusercontent.com/62924322/200496662-987732e3-ad60-46db-b304-ec7e9c80d164.png)<br><br>

*Input Peripherals*<br>
...
An HDMI to DVI cable can be used to connect our Raspberry Pi to our screen if it has a DVI connector.<br>
![dvi-port](https://user-images.githubusercontent.com/62924322/200497073-b1a5462b-7f4b-400a-ace1-b794268c2538.png)<br><br>
Some screens only have a VGA port. We can use an HDMI to VGA converter to connect our Raspberry Pi to such a display.<br>
...
-> Connect everything to our Raspberry Pi at this time. To ensure the safety of all our components, it is crucial to complete these steps in the proper order.<br>
-> Insert the SD card we have set up with Raspberry Pi OS into the microSD card slot on the underside of our Raspberry Pi. Many microSD cards come inside a larger adapter — we can slide the smaller card out using the lip at the bottom.<br>
![sd-card-holder](https://user-images.githubusercontent.com/62924322/200497446-8e5a7b78-bf76-418e-bb77-018e5757dddf.png)<br>
-> It doesn't matter which port we choose; just locate the USB connection end of the mouse's cable and attach the mouse to the Raspberry Pi.<br>
![pi-mouse](https://user-images.githubusercontent.com/62924322/200497523-bd7dbece-fedd-4a1f-9493-5878b661806e.png)<br>
-> Connect the keyboard in the same way.<br>
![pi-keyboard](https://user-images.githubusercontent.com/62924322/200497590-54a4edfc-a13f-4445-9e56-422e6088fa68.png)
-> Make sure our screen is plugged into a wall socket and switched on.<br>
-> Look at our Raspberry Pi's HDMI port(s); we'll see that they have a flat surface on top.<br>
-> Use a cable to connect the screen to Raspberry Pi’s HDMI port — use an adapter if necessary.<br><br>

*Raspberry Pi 4*<br>
Use HDMI0, the first HDMI port on the Raspberry Pi 4, to connect our display. Use HDMI0 instead of HDMI1 (which is closest to the power in port).<br>
![pi-hdmi-1](https://user-images.githubusercontent.com/62924322/200497843-3986968d-9204-47d6-a653-8593f55ab129.png)<br>
We can connect an optional second screen in the same way.<br>
![pi-hdmi-2](https://user-images.githubusercontent.com/62924322/200497909-33ad45df-d6c2-4d2d-9f55-0418a89f48e2.png)<br><br>

*Raspberry Pi 1,2,3*<br>
Connect the screen to the single HDMI port.<br>
![pi-3-hdmi](https://user-images.githubusercontent.com/62924322/200498018-788c29f6-05af-4782-a9b6-c160d44768b9.png)<br>
...
Sound will be played through the speakers on the screen if they are present. If we'd rather, we can also attach speakers or headphones to the audio port.<br>
![pi-headphones](https://user-images.githubusercontent.com/62924322/200498088-0539678b-303e-4533-8a1b-e94a7274542a.png)<br>
We can't turn on or off our Raspberry Pi. It will switch on as soon as we plug it into a power source. Plug the power supply into a socket and connect it to our Raspberry Pi’s power port. We should see a red LED light up on the Raspberry Pi, which indicates that Raspberry Pi is connected to power.<br>
...
**Step 1:** Install Raspberry Pi OS and configure our Pi<br>
...
**Step 2:** Install the Minecraft Server on Raspberry Pi.<br>
...
**Step 3:** Configure our Minecraft Raspberry Pi Server<br>
...
**Step 4:** Connect to the Raspberry Pi Minecraft Server<br>
...
**Step 5:** Extend the Minecraft Server functions with Nukkit plugins<br>
